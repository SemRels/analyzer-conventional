...
LABEL org.opencontainers.image.title="semrel-plugin-analyzer-conventional" \
      org.opencontainers.image.description="semrel plugin: analyzer-conventional" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/analyzer-conventional" \
